...
#i added my applications to the list of installed apps
...
'''the current email_backend value is used in development to send all emails to the terminal instead of user email.
this will be changed in production to ensure emails are sent to user registered emails and not the terminal here'''
